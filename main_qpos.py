...
with torch.no_grad():
        ...
        for x, labels in test_loader:
                ...
                label_hist.append(labels.item())
                output_hist.append(outputs.item())

fig = plt.figure(figsize=(10, 4))
plt.plot(label_hist,  label="Ground truth Joint pos")
plt.plot(output_hist, label="lstm output Joint pos")
plt.legend()
plt.show()
